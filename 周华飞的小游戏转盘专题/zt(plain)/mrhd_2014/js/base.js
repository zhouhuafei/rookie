...
Rookie.prototype.flowNav=function(json){	
	...
	var iParentH=obj.parentNode.offsetHeight;
	...
	var timer=null;			
	var self=this;
	//以下是针对江城美容的栏目页进行的特殊处理,其他专题使用时可以选择删除;
	...
	//以上是针对江城美容的栏目页进行的特殊处理,其他专题使用时可以选择删除;	
	for(var i=0;i<iLen;i++){
	...
	this.addEvent(window,'scroll',function(){
		...
		if(iScrollTop>=iObjTop&&iScrollTop<=(iObjTop+iParentH)-iObjH){
