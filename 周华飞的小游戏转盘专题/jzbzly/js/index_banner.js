...
document.writeln("#focusindex{height: 513px; overflow: hidden; position: relative; }");
document.writeln("#focusindex li{ height: 513px; overflow: hidden; position: absolute; width: 100%; }");
document.writeln("#focusindex .btn{position:absolute;width:100%;height:30px;bottom:0;text-align:center;z-index:9}");
document.writeln("#focusindex .btn span{display:inline-block;_display:inline;_zoom:1;width:14px;height:14px;margin:5px 10px;cursor:pointer;background:#dfdfdf;z-index:9; border-radius:50%}");
...
document.writeln(".banner1{ background: url(images/head01.jpg) no-repeat center;z-index: 1;}");
document.writeln(".banner2{ background: url(images/head02.jpg) no-repeat center;}");
...
document.writeln("");
document.writeln("       <a href=\"javascript:void(0);return false;\" onclick=\"openZoosUrl();return false;\" target=\"_blank\"> <li class=\"banner1\"></li></a>");
document.writeln("        <a href=\"javascript:void(0);return false;\" onclick=\"openZoosUrl();return false;\" target=\"_blank\"><li class=\"banner2\"></li></a>");
document.writeln("");
document.writeln("      </ul>");
document.writeln("");
