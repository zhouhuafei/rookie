...
document.writeln(".banner{ width:100%; height:458px; position:relative; overflow:hidden; margin:150px auto;}");
document.writeln(".banner li{width:100%; height:458px; overflow:hidden; position:absolute;}");
document.writeln(".banner li.pic1{ background:url(banner.jpg) center center no-repeat;}");
document.writeln(".banner li.pic2{ background:url(banner1.jpg) center center no-repeat;}");
document.writeln(".banner li.pic3{ background:url(banner2.jpg) center center no-repeat;}");
document.writeln(".banner li.pic4{ background:url(banner3.jpg) center center no-repeat;}");
...
document.writeln(".banner .btn span{display:inline-block; _display:inline; _zoom:1;  background:#006ab6; width:15px; height:15px; _font-size:0; margin:12px 5px 0px; cursor:pointer; z-index:9; border-radius:50%}");
document.writeln(".banner .btn span.on{ background:#f00; z-index:9}");
document.writeln("");
document.writeln(".banner .preNext{width:44px;height:44px;position:absolute;top:180px;background:url(sprite.png) no-repeat left bottom;cursor:pointer;z-index:9; opacity:0;transition: all 0.3s linear 0s;}");
