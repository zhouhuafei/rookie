...
setTimeout("OnlineIn()",15000);//页面出来15秒后执行
//间隔弹出时间
function OnlineOut(){
    $("#divMenu").fadeOut(200);
...
document.write('<div id="divMenu" style="position: fixed ! important;_position:absolute; _top:expression(offsetParent.scrollTop+100); left:50%; margin-left:-224px; top:150px;  z-index: 2147483647; width:450px; height:300px; border-collapse:collapse;"><img src="http://pfb.skinjc.com/images/swt_qb.jpg" usemap="#myMap" style="box-shadow: 0px 0px 35px #000"/><map name="myMap" id="myMap"><area shape="circle" coords="432,19,17"  style="cursor:pointer" href="javascript:void(0);" onClick="OnlineOut();" /><area shape="rect" coords="208,220,429,258"  style="cursor:pointer" href="javascript:void(0);" onClick="openZoosUrl();return false;" /> </map></div>');
...
//document.write('<style type="text/css">img{border:none;}</style>');
//document.write('<div id="divMenu2" style="position:fixed !important; _position:absolute; right:5px; _top:expression(offsetParent.scrollTop+100); top:70px; z-index:2147483647; width:145px; height:348px;">  <img src="http://pfb.skinjc.com/images/jieri.jpg" usemap="#myMap3"/>  <map name="myMap3" id="myMap3"><area shape="rect" target="_self" coords="125,0,145,19" style="cursor:pointer" href="javascript:void(0);" onClick="closure2();"/> <area shape="rect" coords="0,20,145,348" style="cursor:pointer" href="javascript:void(0);" onClick="openZoosUrl();return false;" target="_blank" /></map></div>')
