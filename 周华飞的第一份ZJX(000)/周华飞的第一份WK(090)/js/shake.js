...
var suspendcode='<DIV id="lovexin1" style="Z-INDEX: 5000; position:fixed;right: 0px; bottom: 0px; width: 214px; height: 124px;cursor:pointer;display:none;">'+	
	...
	"<a href=\"javascript:void(0);\" onclick=\"LR_HideInvite();openZoosUrl();return false;\">"+
		'<img src="http://pfb.skinjc.com/img/doudong.gif"  width="214" height="124" border="0" />'+
	'</a>'+
	'<a href=\"javascript:void(0);\" onclick=\"LR_HideInvite();swt();return false;\"  style="position:absolute;right:2px;bottom:60px;color:#0072c1;" >上海江城皮肤病医院专家</a>'+
